...
import { getInterviewQuestion, saveInterviewPractice } from '@/lib/firebase/interview';
import { VoiceInput } from '@/components/interview/voice-input';
import { evaluateAnswer } from '@/lib/interview/evaluator';
import { ArrowLeft, Brain, CheckCircle, AlertCircle, FileText, BarChart } from 'lucide-react';
