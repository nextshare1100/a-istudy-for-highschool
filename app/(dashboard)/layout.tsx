    ...
    <>
      ...
      <div className="dashboard-layout">
        ...
        <nav className="fixed-footer">
          <Link href="/home" className={`tab ${pathname === '/home' ? 'active' : ''}`}>
          ...
          <Link href="/problems" className={`tab ${pathname === '/problems' ? 'active' : ''}`}>
            <div className="tab-icon">
              <svg width="24" height="24" fill="currentColor" viewBox="0 0 20 20">
          ...
          <Link href="/secondary-exam" className={`tab ${pathname === '/secondary-exam' || pathname.startsWith('/essay') || pathname.startsWith('/interview') ? 'active' : ''}`}>
            <div className="tab-icon">
              <svg width="24" height="24" fill="currentColor" viewBox="0 0 20 20">
          ...
          <Link href="/analytics" className={`tab ${pathname === '/analytics' ? 'active' : ''}`}>
            <div className="tab-icon">
              <svg width="24" height="24" fill="currentColor" viewBox="0 0 20 20">
